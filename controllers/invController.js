...
/* ***************************
 *  Adds to the management page
 * ************************** */
management.addCar = async function (req, res, next) {
  let nav = await utilities.getNav()
...
invCont.editInv = async function (req, res, next) {
  ...
  const classificationSelect = await utilities.addInventoryForm(itemData.classification_id);
...
module.exports = {invCont, invInv, management, buildClass, buildInv, addInv, addClass, editInv, updateInv}