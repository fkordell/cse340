...
async function getInventoryByIdentityId(inventory_id){
  try {
    ...
    return vehicleData.rows
      ...
      console.error("getIdentityBYId " + error)
  }
}
...
module.exports = {getClassifications, getInventoryByClassificationId, getInventoryByIdentityId, addInv, addClass, checkClass}