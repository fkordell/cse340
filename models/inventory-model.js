...
async function getInventoryByClassificationId(classification_id) {
  ...
  /* ***************************
 *  Get all inventory items and invetory_id and name
 * ************************** */
async function getInventoryByIdentityId(inv_id){
  try {
    ...
    return vehicleData.rows
      ...
      console.error("getIdentityByIdentityId " + error)
  }
}
...
* *************************** */
async function addInv(inv_make, inv_model, inv_description, inv_image, inv_thumbnail, inv_price, inv_year, inv_miles, inv_color, classification_id){
  try{
...
module.exports = {getClassifications, getInventoryByClassificationId, getInventoryByIdentityId, addInv, addClass, checkClass, updateInventory, deleteInventory}